...
# ==============================
# Functions from right prompt
# ==============================

function __bobthefish_cmd_duration_left -S -d 'Show command duration'
    ...
    if [ "$CMD_DURATION" -lt 5000 ]
        ...
        __bobthefish_pretty_ms_left $CMD_DURATION s
    else if [ "$CMD_DURATION" -lt 3600000 ]
        set_color $fish_color_error
        __bobthefish_pretty_ms_left $CMD_DURATION m
    else
        set_color $fish_color_error
        __bobthefish_pretty_ms_left $CMD_DURATION h
    end
...
function __bobthefish_pretty_ms_left -S -a ms -a interval -d 'Millisecond formatting for humans'
    set -l interval_ms
    set -l scale 1
    ...
    printf "%s" (math -s$scale "$ms/$interval_ms")
    echo -ns $interval
end

function __bobthefish_timestamp_left -S -d 'Show the current timestamp'
...
function __bobthefish_finish_segments -S -d 'Close open prompt segments'
  ...
  __bobthefish_timestamp_left
  __bobthefish_cmd_duration_left
